const translations = {
  en: {
    ...
    "poker.chart.lead": "Cumulative results across logged sessions.",
    "poker.chart.title": "Profit Trend",
    "poker.note.preflop.description": "Notes on avoiding loose calls from bad positions and keeping ranges clear before the flop.",
    "poker.note.preflop.subtitle": "Poker / Strategy",
    "poker.note.preflop.title": "Preflop Discipline",
    "poker.note.review.description": "A repeatable structure for reviewing big pots, mental state, table selection, and bankroll movement.",
    "poker.note.review.subtitle": "Poker / Session Review",
    "poker.note.review.title": "Session Review Checklist",
    "poker.notes.lead": "Short notes can grow into full articles as the section develops.",
    "poker.notes.title": "Strategy Notes",
    "poker.session.20260702.notes": "Good table selection and patient river decisions.",
    "poker.session.20260705.notes": "Lost two medium pots after defending too wide out of position.",
    "poker.session.20260709.notes": "Value betting thinner worked well against passive callers.",
    "poker.session.20260712.notes": "Short session; quit early after noticing focus dropping.",
    "poker.sessions.lead": "Recent results with enough context to review decisions later.",
    "poker.sessions.title": "Session Log",
    "poker.stat.hourly": "Hourly Rate",
    "poker.stat.sessions": "Sessions",
    "poker.stat.totalProfit": "Total Profit",
    "poker.stat.winRate": "Win Rate",
    "poker.table.buyIn": "Buy-in",
    "poker.table.cashOut": "Cash Out",
    "poker.table.date": "Date",
    "poker.table.game": "Game",
    "poker.table.hours": "Hours",
    "poker.table.notes": "Notes",
    "poker.table.profit": "Profit",
    "button.close": "Close",
    "button.light": "Light",
    "button.menu": "Menu",
    ...
    "home.about.description": "A short introduction to my work, current focus, and the kinds of problems I enjoy solving.",
    "home.about.title": "About Me",
    "home.contact.description": "Find public links, project context, and future collaboration details.",
    ...
    "nav.poker": "Poker",
    "nav.poker.notes": "Strategy Notes",
    "nav.poker.overview": "Poker Overview",
    "nav.poker.sessions": "Session Log",
    "nav.writing": "Writing",
    ...
    "page.contact.lead": "A simple place to find public links and future collaboration details.",
    "page.contact.projects": "Browse selected projects around dashboards, automation, and product experience.",
    "page.contact.projectsLabel": "Projects",
    "page.contact.projectsTitle": "Project work",
    "page.contact.title": "Contact",
    "page.contact.writing": "Read notes about deployment, portfolio storytelling, and building this site.",
    "page.contact.writingLabel": "Writing",
    "page.contact.writingTitle": "Notes and essays",
    ...
    "page.poker.lead": "A place to track session results, bankroll movement, and notes from the tables.",
    "page.poker.title": "Poker Journal",
    ...
    "title.poker": "Poker | YaoYao",
    "title.writing": "Writing | YaoYao",
    "title.writing.career": "Career Growth | YaoYao",
    "title.writing.deployment": "Deployment Notes | YaoYao",
    "article.aboutYaoYao.background": "I am building this site as a clearer home for projects, writing, technical notes, and the story behind the work.",
    "article.aboutYaoYao.backgroundDetail": "The goal is to make my experience easier to browse: what I have built, how I think through problems, and what kind of work I want to keep growing into.",
    "article.aboutYaoYao.description": "A personal profile covering how I work, what I care about, and what I am building toward.",
    "article.aboutYaoYao.focus": "This site will gradually collect work around product experience, data dashboards, workflow automation, and maintainable web systems.",
    "article.aboutYaoYao.focusDetail": "The first version focuses on a few representative themes instead of trying to document everything at once.",
    "article.aboutYaoYao.subtitle": "Background / Working Style / Current Focus",
    "article.aboutYaoYao.title": "About YaoYao",
    "article.aboutYaoYao.work": "I like to clarify complex problems, build reliable workflows, and keep improving experiences that users can actually feel.",
    "article.aboutYaoYao.workDetail": "I care about structure, maintainability, and communication: turning scattered requirements into a plan, then making the result understandable for both technical and non-technical collaborators.",
    "article.contact.description": "The best current contact path is GitHub. More contact links can be added here when they are ready to publish.",
    "article.contact.subtitle": "GitHub / Projects / Writing",
  ...
  zh: {
    ...
    "poker.chart.lead": "按已记录 session 计算的累计收益走势。",
    "poker.chart.title": "收益趋势",
    "poker.note.preflop.description": "记录如何避免在差位置 loose call，并在翻牌前保持更清晰的 range。",
    "poker.note.preflop.subtitle": "Poker / 策略",
    "poker.note.preflop.title": "翻牌前纪律",
    "poker.note.review.description": "一个可重复使用的复盘结构，用来检查大底池、心态、桌况选择和 bankroll 变化。",
    "poker.note.review.subtitle": "Poker / Session 复盘",
    "poker.note.review.title": "Session 复盘清单",
    "poker.notes.lead": "短心得之后可以逐步扩展成完整文章。",
    "poker.notes.title": "策略心得",
    "poker.session.20260702.notes": "桌况选择不错，河牌决策比较耐心。",
    "poker.session.20260705.notes": "两个中等底池输在位置不好时防守太宽。",
    "poker.session.20260709.notes": "面对被动跟注玩家时，薄价值下注效果不错。",
    "poker.session.20260712.notes": "短 session；发现专注度下降后提前离桌。",
    "poker.sessions.lead": "记录最近结果，并保留之后复盘需要的上下文。",
    "poker.sessions.title": "Session 记录",
    "poker.stat.hourly": "小时收益",
    "poker.stat.sessions": "Session 数",
    "poker.stat.totalProfit": "总收益",
    "poker.stat.winRate": "胜率",
    "poker.table.buyIn": "Buy-in",
    "poker.table.cashOut": "Cash Out",
    "poker.table.date": "日期",
    "poker.table.game": "级别",
    "poker.table.hours": "小时",
    "poker.table.notes": "备注",
    "poker.table.profit": "收益",
    "button.close": "关闭",
    "button.light": "浅色",
    "button.menu": "菜单",
    "button.search": "搜索",
    ...
    "footer.site": "站点",
    "footer.social": "社交",
    "home.about.description": "一段简短介绍，用来说明我的工作、当前关注点，以及我喜欢解决的问题。",
    "home.about.title": "关于我",
    "home.contact.description": "这里整理公开链接、项目背景和之后可以扩展的合作信息。",
    ...
    "nav.poker": "Poker",
    "nav.poker.notes": "策略心得",
    "nav.poker.overview": "Poker 总览",
    "nav.poker.sessions": "Session 记录",
    "nav.writing": "文章",
    ...
    "page.contact.lead": "这里整理公开链接和之后可以扩展的合作信息。",
    "page.contact.projects": "浏览和 Dashboard、自动化、产品体验相关的精选项目。",
    "page.contact.projectsLabel": "项目",
    "page.contact.projectsTitle": "项目作品",
    "page.contact.title": "联系我",
    "page.contact.writing": "阅读关于部署、作品集表达，以及搭建这个网站的笔记。",
    "page.contact.writingLabel": "文章",
    "page.contact.writingTitle": "笔记和文章",
    ...
    "page.poker.lead": "用来记录扑克 session 结果、bankroll 变化和牌桌心得。",
    "page.poker.title": "Poker 日志",
    ...
    "title.poker": "Poker | 姚瑶",
    "title.writing": "文章 | 姚瑶",
    "title.writing.career": "职业成长 | 姚瑶",
    "title.writing.deployment": "部署笔记 | 姚瑶",
    "article.aboutYaoYao.background": "我正在把这个网站搭成一个更清晰的入口，用来放项目、文章、技术笔记，以及工作背后的故事。",
    "article.aboutYaoYao.backgroundDetail": "目标是让我的经验更容易浏览：我做过什么、如何思考问题，以及希望继续成长到什么方向。",
    "article.aboutYaoYao.description": "一个个人介绍页面，说明我的工作方式、关注点，以及我正在构建的方向。",
    "article.aboutYaoYao.focus": "这个网站会逐步整理产品体验、数据 Dashboard、workflow 自动化和可维护 Web 系统相关内容。",
    "article.aboutYaoYao.focusDetail": "第一版会先聚焦几个有代表性的主题，而不是一次性把所有内容都写完。",
    "article.aboutYaoYao.subtitle": "背景 / 工作方式 / 当前关注",
    "article.aboutYaoYao.title": "关于姚瑶",
    "article.aboutYaoYao.work": "我喜欢把复杂问题拆清楚，建立可靠 workflow，并持续改进用户能真实感受到的体验。",
    "article.aboutYaoYao.workDetail": "我重视结构、可维护性和沟通：把分散的需求整理成计划，再让结果对技术和非技术协作者都容易理解。",
    "article.contact.description": "目前最适合公开使用的联系入口是 GitHub。之后准备好更多联系方式时，可以继续添加到这里。",
    "article.contact.subtitle": "GitHub / 项目 / 文章",
    "article.contact.title": "联系",
