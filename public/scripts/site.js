const translations = {
  en: {
    ...
    "article.aboutYaoYao.background": "I am building this site as a clearer home for my projects, writing, technical notes, and professional story.",
    ...
    "article.contact.description": "A simple place for contact links and future collaboration details.",
    "article.contact.subtitle": "Email / GitHub / LinkedIn",
  ...
  zh: {
    ...
    "article.aboutYaoYao.background": "我正在把这个网站搭成一个更清晰的入口，用来放项目、文章、技术笔记和职业故事。",
    ...
    "article.contact.description": "一个简单的联系入口，用来放联系方式和未来合作信息。",
    "article.contact.subtitle": "Email / GitHub / LinkedIn",
